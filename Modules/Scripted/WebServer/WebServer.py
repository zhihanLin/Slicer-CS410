...
class SlicerHTTPServer(HTTPServer):
  ...
  def __init__(self, server_address=("",2016), requestHandlers=None, docroot='.', logFile=None, logMessage=None, certfile=None, keyfile=None):
    """
...
class WebServerLogic:
  ...
  def start(self):
    ...
    self.WSSserver = Server(docroot=self.docroot, server_address=("", self.port), logFile=self.logFile,
                                 logMessage=self.logMessage, certfile=certfile, keyfile=keyfile)
